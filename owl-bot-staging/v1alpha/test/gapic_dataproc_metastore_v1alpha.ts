...
describe('v1alpha.DataprocMetastoreClient', () => {
    it('has servicePath', () => {
        const servicePath = dataprocmetastoreModule.v1alpha.DataprocMetastoreClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = dataprocmetastoreModule.v1alpha.DataprocMetastoreClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = dataprocmetastoreModule.v1alpha.DataprocMetastoreClient.port;
        assert(port);
        assert(typeof port === 'number');
    });

    it('should create a client with no option', () => {
        const client = new dataprocmetastoreModule.v1alpha.DataprocMetastoreClient();
        assert(client);
    });
    ...
    describe('getService', () => {
        it('invokes getService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.GetServiceRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Service());
        ...
        it('invokes getService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getService(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.metastore.v1alpha.IService|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMetadataImport', () => {
        it('invokes getMetadataImport without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.GetMetadataImportRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.MetadataImport());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMetadataImport as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getMetadataImport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getMetadataImport(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.metastore.v1alpha.IMetadataImport|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getBackup', () => {
        it('invokes getBackup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.GetBackupRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Backup());
        ...
        it('invokes getBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getBackup(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.metastore.v1alpha.IBackup|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes createService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createService(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.metastore.v1alpha.IService, protos.google.cloud.metastore.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.metastore.v1alpha.IService, protos.google.cloud.metastore.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createService as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('updateService', () => {
        it('invokes updateService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.UpdateServiceRequest());
            request.service = {};
    ...
    describe('deleteService', () => {
        it('invokes deleteService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.DeleteServiceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes deleteService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.deleteService(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.metastore.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.protobuf.IEmpty, protos.google.cloud.metastore.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteService as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('createMetadataImport', () => {
        it('invokes createMetadataImport without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.CreateMetadataImportRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createMetadataImport as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createMetadataImport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createMetadataImport(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.metastore.v1alpha.IMetadataImport, protos.google.cloud.metastore.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.metastore.v1alpha.IMetadataImport, protos.google.cloud.metastore.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createMetadataImport as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('updateMetadataImport', () => {
        it('invokes updateMetadataImport without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.UpdateMetadataImportRequest());
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateMetadataImport as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('exportMetadata', () => {
        it('invokes exportMetadata without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.ExportMetadataRequest());
            request.service = '';
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportMetadata as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes exportMetadata without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.exportMetadata(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.metastore.v1alpha.IMetadataExport, protos.google.cloud.metastore.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.metastore.v1alpha.IMetadataExport, protos.google.cloud.metastore.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.exportMetadata as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('restoreService', () => {
        it('invokes restoreService without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.RestoreServiceRequest());
            request.service = '';
            const expectedHeaderRequestParams = "service=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.restoreService as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes restoreService without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.restoreService(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.metastore.v1alpha.IRestore, protos.google.cloud.metastore.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.metastore.v1alpha.IRestore, protos.google.cloud.metastore.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.restoreService as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('createBackup', () => {
        it('invokes createBackup without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.CreateBackupRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes createBackup without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createBackup(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.metastore.v1alpha.IBackup, protos.google.cloud.metastore.v1alpha.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.metastore.v1alpha.IBackup, protos.google.cloud.metastore.v1alpha.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createBackup as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('listServices', () => {
        it('invokes listServices without error', async () => {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Service()),
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Service()),
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Service()),
            ];
        ...
        it('invokes listServicesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.metastore.v1alpha.Service[] = [];
                stream.on('data', (response: protos.google.cloud.metastore.v1alpha.Service) => {
        ...
        it('uses async iteration with listServices without error', async () => {
            ...
            const responses: protos.google.cloud.metastore.v1alpha.IService[] = [];
    ...
    describe('listMetadataImports', () => {
        it('invokes listMetadataImports without error', async () => {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.MetadataImport()),
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.MetadataImport()),
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.MetadataImport()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listMetadataImports as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listMetadataImportsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.metastore.v1alpha.MetadataImport[] = [];
                stream.on('data', (response: protos.google.cloud.metastore.v1alpha.MetadataImport) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listMetadataImports without error', async () => {
            ...
            const responses: protos.google.cloud.metastore.v1alpha.IMetadataImport[] = [];
    ...
    describe('listBackups', () => {
        it('invokes listBackups without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.metastore.v1alpha.ListBackupsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Backup()),
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Backup()),
              generateSampleMessage(new protos.google.cloud.metastore.v1alpha.Backup()),
            ];
        ...
        it('invokes listBackupsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.metastore.v1alpha.Backup[] = [];
                stream.on('data', (response: protos.google.cloud.metastore.v1alpha.Backup) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
        ...
        it('uses async iteration with listBackups without error', async () => {
            ...
            const responses: protos.google.cloud.metastore.v1alpha.IBackup[] = [];
