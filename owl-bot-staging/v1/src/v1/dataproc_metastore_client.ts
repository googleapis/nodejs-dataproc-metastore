...
export class DataprocMetastoreClient {
  ...
  initialize() {
    ...
    const dataprocMetastoreStubMethods =
        ['listServices', 'getService', 'createService', 'updateService', 'deleteService', 'listMetadataImports', 'getMetadataImport', 'createMetadataImport', 'updateMetadataImport', 'exportMetadata'];
